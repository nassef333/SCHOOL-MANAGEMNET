...
class User extends Authenticatable implements FilamentUser
{
    ...
    {
        return $this->belongsToMany(Training::class, 'teacher_trainings', 'teacher_id', 'training_id');
    }

    public function years()
    {
        return $this->belongsToMany(Year::class, 'teacher_years', 'teacher_id', 'year_id');
    }
