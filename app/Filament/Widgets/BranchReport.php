...
class branchReport extends ChartWidget
{
    ...
    public function getHeading(): string
    {
        ...
        $branchName = $branch_id ? Branch::find($branch_id)->name : 'branch';

        return "{$branchName} Report (Last 10 Days)";
    }
    ...
    protected function getArray()
    {
        ...
        $ratings = Rating::where('branch_id', $branch_id)
